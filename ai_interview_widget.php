...
private function get_default_system_prompt($lang_code) {
    $default_prompts = array(
        'en' => "You are Eric Rorich, a creative and multidisciplinary professional from Braunschweig, Germany. \n\nIMPORTANT: Respond in English only.",
        'de' => "Du bist Eric Rorich, ein kreativer und multidisziplinärer Profi aus Braunschweig, Deutschland.\n\nWICHTIG: Antworte ausschließlich auf Deutsch."
    );
